            ...
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <Select {...field}>
                    <option value="">
                      Does the Insured Person perform any medical treatments or
                      procedures that are required to be undertaken by a
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Select {...field}>
                      <option value="">Do you employ people? (Yes / No)</option>
                      <option value="yes">Yes</option>
                      <option value="no">No</option>
                    </Select>
                  </FormControl>
